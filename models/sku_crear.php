...
if($_POST['option']=="render_select") {
  ...
  $query_select="SELECT ".$tablas_sku[$table]['id'].",".$tablas_sku[$table]['campo']." from $table ORDER BY ".$tablas_sku[$table]['campo'];
...
if($_POST['option']=="cargar_selects_otros_dptos"){
  ...
  $query_excluded = 
  $query=" SELECT ItmsGrpCod as code_dpto, UPPER(ItmsGrpNam) as name_dpto FROM OITB WHERE  ItmsGrpNam NOT LIKE 'INSUMOS%' AND ItmsGrpNam NOT LIKE '01-INS%' AND ItmsGrpCod NOT IN (106,108,127,128,129,130,140,121,135) OR ItmsGrpCod IN (113,115,116,117) ";
...
function getOptionsSelected($table,$valor){
  ...
  $query_table="SELECT $nombre_id, $nombre_campo FROM $table ORDER BY $nombre_campo"; 
